                        ...
                        <Grid container justifyContent="center">
                            <Grid item style={{ textAlign: "center" }} md={6} sm={12}>
                                ...
                                <Typography
                                    ...
                                    sx={{ color: 'black' }}
                                >
                                    Obten tu certificación en WORD ASSOCIATE ante MICROSOFT INTERNACIONAL en 3 meses o menos
                                </Typography>
                                <Typography
                                    variant="h4"
                                    component="h4"
                            ...
                            <Grid item style={{ textAlign: "center" }} md={6} sm={12}>
                                ...
                                >
                                    📋 Incluye Certificado WORD ASSOCIATE ante MICROSOFT INTERNACIONAL
                                </Typography>
                                <Typography
                                    variant="h4"
                                    component="h4"
